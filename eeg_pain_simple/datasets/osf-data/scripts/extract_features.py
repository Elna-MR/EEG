#!/usr/bin/env python3
"""
Feature extraction for osf-data (same as ds005284):
- Uses Riemannian geometry features
- Frequency bands: (4, 8), (8, 12), (13, 30), (30, 45) Hz
- Saves features to packed/features_osf-data.npz
"""
...
def main():
    ...
    ap.add_argument("--npz", default="../packed/osf-data_pain.npz", help="Input preprocessed NPZ (default: ../packed/osf-data_pain.npz)")
    ap.add_argument("--out", default="../packed/features_osf-data.npz", help="Output features NPZ (default: ../packed/features_osf-data.npz)")
    args = ap.parse_args()
