#!/usr/bin/env python3
"""
Riemannian Feature Extraction for osf-data (same as ds005284)
Enhancements:
...
def main():
    ap = argparse.ArgumentParser(description="Improved Riemannian feature extraction for osf-data")
    ap.add_argument("--npz", default="../packed/osf-data_pain.npz", 
                   help="Input preprocessed NPZ")
    ap.add_argument("--out", default="../packed/features_osf-data_riemannian_improved.npz", 
