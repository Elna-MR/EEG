...
def main():
    ...
    ap.add_argument("--features", default="../packed/features_cpcgx.npz", help="NPZ with X,y,subject (default: ../packed/features_cpcgx.npz)")
    ap.add_argument("--epochs", type=int, default=30)
    ap.add_argument("--batch", type=int, default=128)
    ap.add_argument("--lr", type=float, default=1e-3)
    ap.add_argument("--report-dir", default="../reports", help="Directory to save reports (default: ../reports)")
    args = ap.parse_args()
