...
class DANN(pl.LightningModule):
    ...
    def training_step(self, batch, batch_idx):
        ...
        # Domain loss is naturally higher (26-way classification vs 2-way)
...
def main():
    ...
    ap.add_argument("--features", default="../packed/features_ds005284.npz", help="NPZ with X,y,subject (default: ../packed/features_ds005284.npz)")
