...
def main():
    ...
    ap.add_argument("--npz", default="../packed/ds005284_pain.npz", help="Input preprocessed NPZ (default: ../packed/ds005284_pain.npz)")
    ap.add_argument("--out", default="../packed/features_ds005284.npz", help="Output features NPZ (default: ../packed/features_ds005284.npz)")
    args = ap.parse_args()
